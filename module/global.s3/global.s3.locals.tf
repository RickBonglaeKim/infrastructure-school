locals {
  s3-school-name = "${var.prefix}-global-${var.environment}"
  cloud_front-oac-name = "${var.prefix}-global-${var.environment}"
  cloud_front-rhp-name = "${var.prefix}-global-${var.environment}"
